...
labs_16 = pd.read_csv("labs_16.csv", encoding='iso8859_8')
labs_17 = pd.read_csv("labs_17.csv", encoding='iso8859_8')
...
services = pd.read_csv("incident_num_16_17.csv", encoding='iso8859_8')
